...
var ConfigurationWhere = struct {
	...
	ID:              whereHelperint64{field: "\"microsoft_365\".\"configuration\".\"id\""},
	ClientID:        whereHelperstring{field: "\"microsoft_365\".\"configuration\".\"client_id\""},
	ClientSecret:    whereHelperstring{field: "\"microsoft_365\".\"configuration\".\"client_secret\""},
	...
	Active:          whereHelpernull_Bool{field: "\"microsoft_365\".\"configuration\".\"active\""},
	Enable:          whereHelpernull_Bool{field: "\"microsoft_365\".\"configuration\".\"enable\""},
	ProjectIds:      whereHelpertypes_StringArray{field: "\"microsoft_365\".\"configuration\".\"project_ids\""},
}
...
func (o *Configuration) Assets(mods ...qm.QueryMod) assetQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"microsoft_365\".\"asset\".\"configuration_id\"=?", o.ID),
	)
...
func (configurationL) LoadAssets(ctx context.Context, e boil.ContextExecutor, singular bool, maybeConfiguration interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`microsoft_365.asset`),
		qm.WhereIn(`microsoft_365.asset.configuration_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	for _, rel := range related {
		if insert {
			...
			updateQuery := fmt.Sprintf(
				"UPDATE \"microsoft_365\".\"asset\" SET %s WHERE %s",
...
func Configurations(mods ...qm.QueryMod) configurationQuery {
	mods = append(mods, qm.From("\"microsoft_365\".\"configuration\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"microsoft_365\".\"configuration\".*"})
	}
...
func FindConfiguration(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Configuration, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"microsoft_365\".\"configuration\" where \"id\"=$1", sel,
	)
...
func (o *Configuration) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"microsoft_365\".\"configuration\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"microsoft_365\".\"configuration\" %sDEFAULT VALUES%s"
		}
...
func (o *Configuration) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"microsoft_365\".\"configuration\" SET %s WHERE %s",
...
func (o ConfigurationSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"microsoft_365\".\"configuration\" SET %s WHERE %s",
...
func (o *Configuration) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"microsoft_365\".\"configuration\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *Configuration) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"microsoft_365\".\"configuration\" WHERE \"id\"=$1"
...
func (o ConfigurationSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"microsoft_365\".\"configuration\" WHERE " +
...
func (o *ConfigurationSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"microsoft_365\".\"configuration\".* FROM \"microsoft_365\".\"configuration\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, configurationPrimaryKeyColumns, len(*o))
...
func ConfigurationExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"microsoft_365\".\"configuration\" where \"id\"=$1 limit 1)"
